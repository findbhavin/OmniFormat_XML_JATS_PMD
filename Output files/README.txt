======================================================================
OmniJAX JATS 1.4 Publishing DTD Conversion Package
======================================================================

GENERATED FILES:
--------------------------------------------------
1. article.xml           - JATS 1.4 Publishing DTD XML
2. article.html          - HTML version for web viewing
3. media/                - Extracted images and media files
4. validation_report.json- Comprehensive validation report
5. README.txt            - This file

COMPLIANCE INFORMATION:
--------------------------------------------------
• JATS 1.4 Publishing DTD compliant
...
--------------------------------------------------
1. ✓ Validate with PMC Style Checker:
   https://pmc.ncbi.nlm.nih.gov/tools/stylechecker/
2. ✓ Review validation_report.json for warnings
3. ✓ Verify DOI and article metadata are complete
4. ✓ Check author affiliations and ORCID IDs
5. ✓ Ensure all figures have captions and alt text
6. ✓ Verify references are properly formatted
7. ✓ Review table formatting (captions, structure)
8. ✓ Validate special characters and math notation

TECHNICAL DETAILS:
--------------------------------------------------
• Input file: 20260120_083015_5c13d7af_10._Uma_Phalswal_5599_SYSMETA.docx
• Generated: 2026-01-20T08:30:43.327643
• JATS Version: 1.4 Publishing DTD
• Tools: Pandoc 3.x, lxml
...
2. HTML version is provided for web viewing
